...
function potential_weibo_new(data){
    ...
    if (!item){
        ...
        for (i=item_i_time; i<max_i_time; i++){
            ...
            html += '<div><img class="img-circle" src="'+item[i].photo_url+'" style="width: 30px;height: 30px;position: relative;margin-left: 2%;margin-top: 2%;float:left;"></div>';
            html += '<div>';
            //html += '<a target="_blank" href=" " class="user_name" style="float:left;">央视新闻</a>';
            html += '<a target="_blank" href="/index/viewinformation/?uid='+item[i].uid+'" class="user_name" style="float:left;">'+item[i].uname+'</a>';
            ...
            html += '<p style="text-align:left;width: 92%;position: relative;margin-top: 15%;margin-left: 6%;font-family: Microsoft YaHei;"><font color="black">'+item[i].text+'</font></p>';
            ...
            html += '<span style="display: inline-block;margin-bottom: 2%;margin-left: 3%;float:left;">'+item_timestamp_datetime+'</span>';
            html += '<span style="float: left;margin-left: 20%;">评论数('+item[i].comment+')&nbsp;&nbsp;|&nbsp;&nbsp;</span>';
            html += '<span style="float: left;margin-left: 1%;">转发数('+item[i].retweeted+')&nbsp;&nbsp;|&nbsp;&nbsp;</span>';
            html += '<span style="float: left;margin-left: 1%;">当前参与量('+item[i].current_count+')&nbsp;&nbsp;|&nbsp;&nbsp;</span>';
            //html += '<span id="oule" style="margin-top: -3%;display: inline-block;margin-left: 54%;">转发数('+Math.round(Math.random()*1000)+')&nbsp;&nbsp;&nbsp;|</span>';
            html += '<span style="margin-top: -1.5%;float: left;margin-left: 53.5%;" >&nbsp;&nbsp;未来参与量('+item[i].prediction_count+')</span>';
...
function current_weibo_new(data){
    ...
    if (!item){
        ...
        for (i=item_i_time; i<max_i_time; i++){
            ...
            //html += '<span style="float:left">2016-08-19 21:11:46&nbsp;&nbsp;</span>';
            html += '<span style="display: inline-block;margin-bottom: 2%;margin-left: 3%;float:left;">'+item_timestamp_datetime+'</span>';
            html += '<span style="float: left;margin-left: 40%;">转发数('+item[i].retweet+')&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>';
            //html += '<span id="oule" style="margin-top: -3%;display: inline-block;margin-left: 54%;">转发数('+Math.round(Math.random()*1000)+')&nbsp;&nbsp;&nbsp;|</span>';
            html += '<span style="margin-top: -1.5%;float: left;margin-left: 49.5%;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;评论数('+item[i].comment+')</span>';
            //html += '<span style="margin-top: -3%;display: inline-block;" >&nbsp;&nbsp;&nbsp;&nbsp;评论数('+Math.round(Math.random()*1000)+')</span>';
            //html += '&nbsp;&nbsp;&nbsp;&nbsp;</span>';
            html += '</p>';
            html += '</div>';                       
